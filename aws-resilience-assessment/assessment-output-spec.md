...
> 请 `aws-resilience-assessment` skill 在生成韧性评估报告时，按照本规范的结构组织报告内容，确保混沌工程阶段可直接消费。  
>
> **两种输出方式（任选）**：
...
*本规范由 `chaos-engineering-on-aws` skill 定义，反馈给 `aws-resilience-assessment` skill 设计者*  
